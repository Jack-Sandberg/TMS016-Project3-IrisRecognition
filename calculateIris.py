...
def computeNormalizedIrisAndSave(path):
...
for image in tqdm(unwrappedImagePaths):
    computeNormalizedIrisAndSave(image)


for personIndex in range(len(imagePaths)):
    for leftRightIndex in range(len(imagePaths[personIndex])):
        for imageIndex in range(len(imagePaths[personIndex][leftRightIndex])):
            pass
            #computeNormalizedIrisAndSave(imagePaths[personIndex][leftRightIndex][imageIndex])